/* publishes messages to bend to ground with base at +0.5 radian
   for Kuka Youbot
...
while (ros::ok()) {
  ...
  // msg.header.seq = iSeq;
   ...
   msg.points[ind].positions[1]=0.1;
   msg.points[ind].positions[2]=-3.11;
   ...
   */
   msg.points[ind].velocities[0] = 0;
   msg.points[ind].velocities[1] = 0;
   msg.points[ind].velocities[2] = 0;
   msg.points[ind].velocities[3] = 0.5;
   msg.points[ind].velocities[4] = 0;
